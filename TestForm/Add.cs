...
namespace TestForm
{
    ...
    class Add
    {      // Xây dựng hàm dùng để add XtratabPage và XtraTabcontrol 
        //(Hàm này đặt trong Project có dạng Library để Build thành file .dll .
        // Mục đích : viết 1 lần nhưng sử dụng cho nhiều Project khác nhau)
